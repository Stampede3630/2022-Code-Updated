...
public class Shooter extends SubsystemBase implements Logged {
  ...
  .withMotorOutput(new MotorOutputConfigs()
    ...
    .withSlot0(new Slot0Configs()
      .withKP(.1));
  private final PositionDutyCycle hoodPositionDrive = new PositionDutyCycle(0, 0, false, 0, 0, false, false, false);
  ...
  private final VelocityVoltage shooterVelocityDrive = new VelocityVoltage(0);
